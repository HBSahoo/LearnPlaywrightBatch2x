...
if (true) { var name = "Mamta"; } console.log(name);
...
if (true) { let age = 18; console.log(age); } // console.log(age);

let percentage = 10; percentage = 20; // let percentage = 30;
...
const user = { name: "Mamta" }; user.name = "Neha"; // Allowed: mutating property // user = { name: "Deepti" }; // TypeError: reassignment not allowed